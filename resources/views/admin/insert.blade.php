    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <form action="{{ route('storeAdmin') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nama Admin" value="{{ old('name') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="username" class="form-control @error('username') is-invalid @enderror" placeholder="Username Admin" value="{{ old('username') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="nik" id="nik" class="form-control @error('nik') is-invalid @enderror" placeholder="NIK Admin" value="{{ old('nik') }}">
